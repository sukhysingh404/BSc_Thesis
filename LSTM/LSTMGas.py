...
#Point to the LSTM Gas dataset
df = pd.read_csv(r'LSTMDatasets\LSTMGas.csv')


weather_features = ['gas_usage', 'days_from_start',  
                     "temperature", "apparent_temperature","precipitation","wind_speed"]

social_features = ['gas_usage', 'days_from_start', 
                   "residents", "hometype_flat", "hometype_house", "build_era","income"]

calandar_features = ['gas_usage', 'days_from_start',
...
calandar_social_features = ['gas_usage', 'days_from_start', 
             "day_4", "day_5", "day_6", "day_0", "day_1", "day_2", "day_3",
             "month_1", "month_2", "month_3", "month_4", "month_5", "month_6", "month_7", "month_8", "month_9", "month_10", "month_11",
             "month_12", "residents", "hometype_flat", "hometype_house", "build_era","income"]

calandar_weather_features = ['gas_usage', 'days_from_start', 
             "day_4", "day_5", "day_6", "day_0", "day_1", "day_2", "day_3",
             "month_1", "month_2", "month_3", "month_4", "month_5", "month_6", "month_7", "month_8", "month_9", "month_10", "month_11",
             "month_12", "temperature", "apparent_temperature","precipitation","wind_speed"]

calandar_weather_social_features = ['gas_usage', 'days_from_start', 
             "day_4", "day_5", "day_6", "day_0", "day_1", "day_2", "day_3",
             "month_1", "month_2", "month_3", "month_4", "month_5", "month_6", "month_7", "month_8", "month_9", "month_10", "month_11",
             "month_12", "temperature", "apparent_temperature","precipitation","wind_speed", 
             "residents", "hometype_flat", "hometype_house", "build_era", "income"]
weather_social_features = ['gas_usage', 'days_from_start', 
                     "temperature", "apparent_temperature","precipitation","wind_speed", 
                     "residents", "hometype_flat", "hometype_house", "build_era","income"]

no_features=['gas_usage']


#Replace the following variable with which set of features you will like to train the model with
features = calandar_weather_social_features
...
checkpoint_filepath = 'GasTest.keras'
