...
def main():
    data = pd.read_csv(r'TFTDatasets\TFTElectricity.csv', index_col=0, sep=',', decimal='.', encoding = "ISO-8859-1")
   ...
   # best_model_path = r"C:\Users\sukhy\Documents\Thesis\Models\TFT\Electricity\Calendar\Calandar_1\checkpoints\epoch=6-step=1792.ckpt"
